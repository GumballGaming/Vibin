export const themes = {
  ...
  dusk: { name: "Dark", description: "A clean charcoal workspace.", colors: ["#191821", "#24222e", "#58566b"], vars: { bg: "#191821", surface: "#24222e", "surface-warm": "#302d3d", fg: "#f0edf7", "fg-2": "#cbc5d8", muted: "#928ba3", meta: "#58566b", border: "#413d50", "border-soft": "#312e3c", accent: "#58566b", "accent-on": "#e4e1ec" } },
