export const themes = {
  ...
  dusk: { name: "Dark", description: "A clean charcoal workspace.", colors: ["#191821", "#24222e", "#a998e8"], vars: { bg: "#191821", surface: "#24222e", "surface-warm": "#302d3d", fg: "#f0edf7", "fg-2": "#cbc5d8", muted: "#928ba3", meta: "#a998e8", border: "#413d50", "border-soft": "#312e3c", accent: "#a998e8", "accent-on": "#17151d" } },
